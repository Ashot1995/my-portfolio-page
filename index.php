...
<header class="header">
    <div class="container">
        <img class="profile-image img-responsive pull-left" src="assets/images/profile.png" style="height: 200px ;width:200px" alt="Ashot photo" />
...
<form method="post" action="" id="send"
    ...
    <img src="close.png" alt="close" style="height: 20px ;width: 20px ; position: absolute ;    margin-left: 98%;
    margin-top: -2%; " id = 'close' >
    ...
    <textarea name="comment" rows="7" placeholder=" Message *" id="content" class="form-control"
              style="border-bottom: 1px solid blue ;max-width: 100%;min-width: 100%;" maxlength="2000" required></textarea>
...
<!--                                </a>-->
                            ...
                            <!--<a class="btn btn-cta-secondary"-->
                               <!--href="" id="cli"><i class="fa fa-thumbs-o-up"></i>Like</a><p id="count"></p>-->
                        </div><!--//item-->
                        <hr class="divider"/>
                        <div class="item row">
                        ...
                        <div class="desc col-md-8 col-sm-8 col-xs-12">
                            ...
                            <p>Yandex translate  created  javascript ,Jquery and Ajax in languages</p>
                            <p><a class="more-link" href="https://github.com/Ashot1995/Yandex-translate" target="_blank"><i
                                    class="fa fa-external-link"></i> View code</a></p>
                        </div><!--//desc-->
                    </div><!--//item-->
                ...
                <div class="section-inner">
                    ...
                    <div class="content">
                        <ul class="list-unstyled">
                            <li><i class="fa fa-map-marker"></i><span class="sr-only">Location:</span>Gyumri,Armenia
                            </li>
                            <li><i class="fa fa-phone"></i><span class="sr-only">Phone number:</span>+374 98 01 62 77
                            </li>
                            <li><i class="fa fa-envelope-o"></i><span class="sr-only">Email:</span><a href="#">ashotgharakeshishyan@gmail.com</a>
                            </li>
                ...
                <div class="section-inner">
                    ...
                    <div class="content">
                        ...
                        <div class="skillset">
                            ...
                            <div class="item">
                                <h3 class="level-title">HTML5, CSS3, SASS &amp; LESS<span class="level-label">90%</span>
                                </h3>
                                <div class="level-bar">
                                    <div class="level-bar-inner" data-level="90%">
                                    </div>
                    ...
                    <div class="content">
                        <ul class="list-unstyled">
                            <li><i class="fa fa-headphones"></i> <a href="https://www.youtube.com/watch?v=1KbauuM9EhY">River
                                Flows In You</a></li>
                            <li><i class="fa fa-headphones"></i> <a href="https://www.youtube.com/watch?v=AeA3AL4jcIQ">Best music
                                </a></li>
