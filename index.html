...
<div id="send"
    ...
    <input type="email" name="email" placeholder="Your E-mail Address *" id="mail" class="form-control"
           style="border-bottom: 1px solid blue" required>
    <textarea name="content" rows="7" placeholder=" Message *" id="content" class="form-control"
              style="border-bottom: 1px solid blue ;max-width: 100%;min-width: 100%;" maxlength="2000"
              required></textarea>
    <button id="submit" class="clearfix btn btn-info">Send</button>
                ...
                <div class="section-inner">
                    ...
                    <div class="content">
                        <p>Hi, My name is Ashot.
                            I'm a web developer with over 5 years of experience in the field.
                            I work full time for a software company.
                            I've designed, developed and tested many projects.
                            I write clean, responsive code and always hit my deadlines on time.
                            I have experience with analytics, version control and working in a team environment.
                            I know a plethora of computer languages and will take the time to learn a new language
                            if needed. I'm confident, hard working and dependable.
                            I will work around the clock until my clients and/or employers are satisfied.
                        </p>
                    ...
                    <div class="content">
                        ...
                        <div class="item row">
                            ...
                            <div class="desc col-md-8 col-sm-8 col-xs-12">
                                ...
                                <p><a class="more-link" href="https://mekhitar.am/"
                                      target="_blank"><i
                                            class="fa fa-external-link"></i> View </a></p>
                            </div>
                        </div>
                        ...
                        <div class="item row">
                            ...
                            <div class="desc col-md-8 col-sm-8 col-xs-12">
                                <h3 class="title"><a
                                        href="https://github.com/Ashot1995/Yandex-translate"
                                        target="_blank">Shopping site</a></h3>
        ...
        <div class="secondary col-md-4 col-sm-12 col-xs-12">
            ...
            <aside class="skills aside section">
                <div class="section-inner">
                    ...
                    <div class="content">
                        ...
                        <div class="item">
                            <h3 class="level-title">Nano, Vim, Atom, Phpstorm<span class="level-label">95%</span></h3>
                            <div class="level-bar">
            ...
            <aside class="list music aside section">
                <div class="section-inner">
                    ...
                    <div class="content">
                        <ul class="list-unstyled">
                            <li><i class="fa fa-headphones"></i> <a href="https://www.youtube.com/watch?v=8Z5EjAmZS1o">Yiruma's Greatest Hits</a></li>
...
<footer class="footer">
    <div class="container text-center">
        ...
        <strong class="copyright"><img src="a.g.png" style="height: 20px;width: 20px" alt="A.G"></i> by <a
                href="https://ashot1995.github.io/my-portfolio-page/" target="_blank">Ashot Gharakeshishyan</a></strong>
    </div>
</footer>
